...
### 9. Как бихме дефинирали функция, която работи с **някой тип**, който имплементира `MyTrait`, без да знаем конкретния `Output` тип? Какви са вариантите и ограниченията? Дадено е:  
